...
caminho = 'C:\\Users\\pablo.pamf\\Documents\\2021\\Macro_NB\\NB_POR_CHAT\\'
...
#dados = pd.DataFrame()
#dados['ind'] = ind
nb = re.compile(r"[0-9]{3}\.[0-9]{3}\.[0-9]{3}\-[0-9]{1}\s|[0-9]{9}\-[0-9]{1}\s")
for i in range(len(files)):
    ...
    if v_html == 'html':
        ...
        if len(res_nb_unic) > 0:
            ...
            dados['NÚMERO BENEFÍCIO'] = pd.Series(res_nb_unic)
